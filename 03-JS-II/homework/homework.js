...
function esEntero(numero) {
  ...
  // Tu código:
  //otra manera de hacer: return Number.isInteger(numero)
  // otra manera de hacer: return numero % 1 === 0;
...
function fizzBuzz(numero) {
  ...
  else if( numero % 3 ===0){return "fizz"}else if(numero % 5 ===0){return "buzz"}else{return numero};
}
...
function tablaDelSeis(){
  ...
  //Escribe tu código aquí   
  var array = [];
  for (var i = 0 ; i<11 ; i++){array.push(i*6)}{return array};
...
function doWhile(numero) {
  ...
  var contador =8;
  var resultado =0;
  do {resultado +=5; contador -=1}while(contador!==0){return numero + resultado};
